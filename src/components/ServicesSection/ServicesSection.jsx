    ...
    <section className="relative py-20 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative bg-neutral-200/30 rounded-3xl p-8 text-neutral-800 overflow-hidden h-[420px] flex flex-col justify-between">
            <div>
            ...
            <img
              ...
              className="absolute bottom-0 right-0 h-3/4 w-auto object-contain opacity-20"
              style={{ zIndex: 0 }}
            />
